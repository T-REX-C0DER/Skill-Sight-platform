(function(){
  const questions = window.phpQuestions || [];
  ...
  // Sanity checks: ensure required DOM elements exist and handle empty question set
  ...
  if(missingElements.length){
    console.error('php-test: missing required DOM elements:', missingElements);
  }
  ...
  function render(){
    ...
    try{
      ...
      console.error('php-test: render error', err);
    }
  }
  ...
  // Basic timer (30 minutes default)
  let time = 30*60;
  ...
  if(timerEl){
    ...
    console.warn('php-test: timer element not found');
  }
})();