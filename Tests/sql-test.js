(function(){
  const questions = window.sqlQuestions || [];
  ...
  if(missingElements.length){
    console.error('sql-test: missing required DOM elements:', missingElements);
  }
  ...
  function render(){
    ...
    try{
      ...
      console.error('sql-test: render error', err);
    }
  }
  ...
  if(timerEl){
    ...
    console.warn('sql-test: timer element not found');
  }
})();
